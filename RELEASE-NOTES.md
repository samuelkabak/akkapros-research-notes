...
This repository accompanies the [akkapros](https://github.com/samuelkabak/akkapros) toolkit (v3.0.1+), the open-source Python package for Akkadian prosody analysis.
